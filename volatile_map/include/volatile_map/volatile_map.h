...
private:
  ...
  bool markHoned_(volatile_map::MarkHoned::Request &req, volatile_map::MarkHoned::Response &res);
  ...
  ros::ServiceServer markCollectedServer_, markAssignedServer_,  markHonedServer_;
